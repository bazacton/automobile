...
// print_r(get_user_meta($automobile_author_id[0]));
...
?>
<div class="cs-inventories-main-box detail-v2 detail-v3" data-ajaxurl="<?php echo admin_url( 'admin-ajax.php' ) ?>" id="primary">
                        ...
                        <?php if ( is_array( $automobile_inv_gallery ) && ! empty( $automobile_inv_gallery ) ) { ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="slider-holder">
                                    ...
                                    <ul class="cs-bottom-slides-thumb">
                                        <?php
                                        $counter_image = 0;
                                        foreach ( $automobile_inv_gallery as $automobile_slider_img ) {
                                            if ( $counter_image < 1 ) {
                                                $automobile_slider_image_thumb_first = automobile_get_image_thumb( $automobile_slider_img, 'automobile_var_media_6' );
                                            }
                                            $automobile_slider_image_thumb = automobile_get_image_thumb( $automobile_slider_img, 'automobile_var_media_6' );

                                            if ( $automobile_slider_image_thumb != '' ) {
                                                ?>
                                                <li>
                                                    <img class="lazyload no-src" src="<?php echo esc_url( $automobile_slider_image_thumb ) ?>" alt="" />
                                                </li>
                                                <?php
                                            }
                                            $counter_image ++;
                                        ...
                                        <?php if ( $automobile_video_url != '' ) { ?>
                                            <li>
                                                <div class="play"> <img class="no-src lazyloaded" src="<?php echo $automobile_slider_image_thumb_first; ?>" alt="" style="visibility: visible; zoom: 1; opacity: 1;">
                                                </div></li>
                                        <?php } ?>
                                    </ul>
