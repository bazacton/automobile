...
if (isset($qrystr) && $qrystr != '') {
    ...
    <div class="your-search">
                    ...
                    if ($qry_val != '') {
                        ...
                        if (is_array($qry_val)) {
                            ...
                            if ($qry_var == 'dealer_type') { // only remove the 
                                ...
                                echo '<a href="' . automobile_remove_qrystr_extra_var($qrystr, $qry_var) . '">' . str_replace("+", " ", $qry_val) . ' <i class="icon-cross3"></i></a>';
                            }
                            echo '</li>';
                        }
                    }
        ...
        <a class="clear-tags" href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html(automobile_var_plugin_text_srt('automobile_var_clear_all')) ?></a>
    </div>
<?php } ?>