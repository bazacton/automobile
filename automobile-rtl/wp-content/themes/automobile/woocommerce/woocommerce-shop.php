 ...
 */
get_header();
$var_arrays = array('post', 'automobile_node', 'automobile_sidebarLayout', 'column_class', 'automobile_xmlObject', 'automobile_node_id', 'column_attributes', 'automobile_elem_id');
...
if (is_shop()) {
    ...
    $automobile_page_bulider = get_post_meta($automobile_shop_id, "automobile_page_builder", true);
    ...
    <div class="main-section">
        ...
        $automobile_postObject = get_post_meta($automobile_shop_id, 'automobile_var_full_data', true);
        $automobile_page_layout = get_post_meta($automobile_shop_id, 'automobile_var_page_layout', true);
        $automobile_page_sidebar_right = get_post_meta($automobile_shop_id, 'automobile_var_page_sidebar_right', true);
        $automobile_page_sidebar_left = get_post_meta($automobile_shop_id, 'automobile_var_page_sidebar_left', true);
        $automobile_page_bulider = get_post_meta($automobile_shop_id, "automobile_page_builder", true);
        ...
        if (!empty($automobile_xmlObject) && is_array($automobile_xmlObject) && count($automobile_xmlObject) > 1) {
            if (isset($automobile_page_layout)) {
            ...
            if (post_password_required()) {
                echo '<header class="heading"><h6 class="transform">' . get_the_title($automobile_shop_id) . '</h6></header>';
                echo automobile_password_form();
            } else {
                $width = 840;
                $height = 328;
                $automobile_post_thumbnail_id = get_post_thumbnail_id($automobile_shop_id);
                $image_url = automobile_attachment_image_src($automobile_post_thumbnail_id, $width, $height);
                wp_reset_postdata();
                ...
                if ($pageSidebar != true) {
                    ...
                    <div class="page-section">
                        <div class="container">
                            ...
                            $content_post = get_post($automobile_shop_id);
            ...
            foreach ($automobile_xmlObject->column_container as $column_container) {
                ...
                $automobile_section_bg_image = $automobile_var_section_title = $automobile_var_section_subtitle = $automobile_section_bg_image_position = $automobile_section_bg_image_repeat = $automobile_section_bg_color = $automobile_section_padding_top = $automobile_section_padding_bottom = $automobile_section_custom_style = $automobile_section_css_id = $automobile_layout = $automobile_sidebar_left = $automobile_sidebar_right = $css_bg_image = '';
                ...
                if (isset($column_container)) {
                    ...
                    if (isset($automobile_section_background_option) && $automobile_section_background_option == 'section-custom-background-image') {
                        ...
                        if (isset($automobile_section_bg_image) && $automobile_section_bg_image != '') {
                            if (isset($automobile_section_parallax) && (string) $automobile_section_parallax == 'yes') {
                                $automobile_section_bg_imageg = 'url(' . $automobile_section_bg_image . ') ' . $automobile_section_bg_image_position . ' ' . ' fixed';
                            } else {
                        ...
                        if ($url['host'] == cs_get_server_data("SERVER_NAME")) {
                            ...
                            $section_video_element = '<div class="page-section-video cs-section-video">
                                        <video id="player' . $rand_player_id . '" width="100%" height="100%" ' . $automobile_video_autoplay . ' loop="true" preload="none" volume="false" controls="controls" class="nectar-video-bg   cs-video-element"  ' . $mute_control . ' >
                                            <source src="' . esc_url($automobile_section_video_url) . '" type="' . $file_type . '">
                                        </video>
                                    </div>';
                        } else {
                ...
                ?>
                <!-- Page Section -->
                <div <?php echo automobile_allow_special_char($automobile_section_css_id); ?> class="page-section <?php echo sanitize_html_class($parallax_class); ?>" <?php echo automobile_allow_special_char($parallax_data_type); ?>  <?php echo automobile_allow_special_char($section_style_element); ?> >
                    <?php
                        ...
                        if (isset($automobile_layout) && ( $automobile_layout != '' || $automobile_layout != 'none' )) {
                            ...
                            if ($automobile_var_section_title != '' || $automobile_var_section_subtitle != '') {
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="cs-element-title" style="margin-bottom:27px;">
                                        <?php if ($automobile_var_section_title != '') { ?>
                                            <h2 style="font-size:24px !important; letter-spacing:1px !important; text-align:center; margin-bottom:20px;"><?php echo esc_html($automobile_var_section_title) ?></h2>
            ...
            if (isset($automobile_page_layout) && $automobile_sidebarLayout <> '' && $automobile_sidebarLayout <> "none") {

                echo '</div>';
            }
            if (isset($automobile_page_layout) && $automobile_sidebarLayout <> '' and $automobile_sidebarLayout <> "none" and $automobile_sidebarLayout == 'right') :
