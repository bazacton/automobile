...
if (!class_exists('automobile_dealer_custom_fields_options')) {
    ...
    class automobile_dealer_custom_fields_options {
        ...
        public function __construct() {
            add_action('wp_ajax_automobile_pb_dealer_text', array(&$this, 'automobile_pb_dealer_text'));
            add_action('wp_ajax_automobile_pb_dealer_textarea', array(&$this, 'automobile_pb_dealer_textarea'));
            add_action('wp_ajax_automobile_pb_dealer_dropdown', array(&$this, 'automobile_pb_dealer_dropdown'));
            add_action('wp_ajax_automobile_pb_dealer_date', array(&$this, 'automobile_pb_dealer_date'));
            add_action('wp_ajax_automobile_pb_dealer_email', array(&$this, 'automobile_pb_dealer_email'));
            add_action('wp_ajax_automobile_pb_dealer_url', array(&$this, 'automobile_pb_dealer_url'));
            add_action('wp_ajax_automobile_pb_dealer_range', array(&$this, 'automobile_pb_dealer_range'));
         ...
         */
        public function automobile_pb_dealer_text($die = 0, $automobile_return = false) {
         ...
         */
        public function automobile_pb_dealer_textarea($die = 0, $automobile_return = false) {
            global $automobile_f_counter, $automobile_dealer_cus_fields, $automobile_var_plugin_static_text;
         ...
         */
        public function automobile_pb_dealer_dropdown($die = 0, $automobile_return = false) {
         ...
         */
        public function automobile_pb_dealer_date($die = 0, $automobile_return = false) {
            global $automobile_f_counter, $automobile_dealer_cus_fields, $automobile_var_plugin_static_text;
            $strings = new automobile_plugin_all_strings;
            $strings->automobile_var_plugin_option_strings();
         ...
         */
        public function automobile_pb_dealer_email($die = 0, $automobile_return = false) {
            global $automobile_f_counter, $automobile_dealer_cus_fields, $automobile_var_plugin_static_text;
            $strings = new automobile_plugin_all_strings;
            $strings->automobile_var_plugin_option_strings();
         ...
         */
        public function automobile_pb_dealer_url($die = 0, $automobile_return = false) {
            global $automobile_f_counter, $automobile_dealer_cus_fields, $automobile_var_plugin_static_text;
         ...
         */
        public function automobile_pb_dealer_range($die = 0, $automobile_return = false) {
            global $automobile_f_counter, $automobile_dealer_cus_fields, $automobile_var_plugin_static_text;
            $strings = new automobile_plugin_all_strings;
            $strings->automobile_var_plugin_option_strings();
            ...
            $automobile_fields_markup .= $this->automobile_fields_select(array(
                ...
                'title' => esc_html('$automobile_var_required'),
                'std' => '',
                'options' => array(
                    'no' => automobile_var_plugin_text_srt('automobile_var_no'),
                    'yes' => automobile_var_plugin_text_srt('automobile_var_yes')
                        ...
                        switch ($automobile_type) {
                            ...
                            case('dropdown'):
                                ...
                                if (isset($_POST["dealer_cus_field_{$automobile_type}"]['options_values'][$values]) && (strlen(implode($_POST["dealer_cus_field_{$automobile_type}"]['options_values'][$values])) != 0)) {
                                    ...
                                    $error = 1;
                                    $error_msg .= sprintf(automobile_var_plugin_text_srt('automobile_var_select_atleast_one_option'), $dealer_cus_field_array['label']);
                                }
                                $dropdown_counter++;
                                break;
                            case('date'):
