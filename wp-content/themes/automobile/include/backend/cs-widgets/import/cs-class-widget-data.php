...
if (!class_exists('automobile_var_widget_data')) {
    ...
    class automobile_var_widget_data {
        ...
        public function __construct() {
            ...
            add_action('wp_ajax_automobile_widget_file_delete', array(__CLASS__, 'automobile_widget_file_delete'));
        }
        ...
        public static function enqueue_admin_scripts($hook) {
            ...
            wp_localize_script('widget_data', 'widgets_url', array('url' => get_admin_url(false, 'widgets.php')));
        }
        ...
        public static function export_settings_page() {
            ...
            <div class="widget-data cs-export-widget-settings">
                ...
                <div class="cs-export-wrapper">
                    ...
                    <div id="cs-widget-export-form">
                        <div class="title">
                            <h3><?php echo automobile_var_theme_text_srt('automobile_var_widget_setting'); ?></h3>
                            <span class="cs-select-butns">
                                <a class="select-all"><?php echo automobile_var_theme_text_srt('automobile_var_select_all'); ?></a>
                                <a class="unselect-all"><?php echo automobile_var_theme_text_srt('automobile_var_unselect_all'); ?></a>
                            </span>
                            <div class="clear"></div>
                        </div>
                        <div class="sidebars">
                                    ...
                                    <div class="sidebar">
                                        ...
                                        <div class="widgets">
                                            ...
                                            foreach ($widget_list as $widget) :
                                                ...
                                                $sidebar_active = ($sidebar_name == 'wp_inactive_widgets') ? 'inactive' : 'active';
                                                ?>
                                                <div class="import-form-row">
                                                    <input class="<?php echo automobile_allow_special_char($sidebar_active); ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr($widget); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
            ...
            <?php
            $automobile_output = ob_get_clean();
            ...
            <?php if (isset($_POST['file_name']) && $_POST['file_name'] != '') : ?>
                    ...
                    <div class="cs-import-wrapper">
                        ...
                        <div id="cs-import-widget-form">
                            ...
                            <div class="title">
                                ...
                                <span class="cs-select-butns">
                                    <a class="imp-select-all"><?php echo automobile_var_theme_text_srt('automobile_var_select_all'); ?></a>
                                    <a class="imp-unselect-all"><?php echo automobile_var_theme_text_srt('automobile_var_unselect_all'); ?></a>
                                </span>
                                <div class="clear"></div>
                            </div>
                            <div class="sidebars">
                                            ...
                                            <div class="sidebar">
                                                ...
                                                <div class="widgets">
                                                    ...
                                                    foreach ($widget_list as $widget) :
                                                        ...
                                                        ?>
                                                        <div class="import-form-row">
                                                            <input class="<?php echo automobile_allow_special_char($sidebar_active); ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr(printf('widgets[%s][%d]', $widget_type, $widget_type_index)); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
                ...
                <?php endif; ?>
                            ...
                            <p>
                                ...
                                <label for="clear-current"><?php echo automobile_var_theme_text_srt('automobile_var_clear_current'); ?></label><br/>
                                <span class="description"><?php echo automobile_var_theme_text_srt('automobile_var_all_active'); ?></span>
                            </p>
                    ...
                    ?>
                    <p><?php echo automobile_var_theme_text_srt('automobile_var_put_file'); ?></p>
                    <p>
                        <input type="text" id="cs-widget-upload-file" />
                    </p>
                    <input type="button" id="widget-import-submit" class="button" value=<?php echo automobile_var_theme_text_srt('automobile_var_show_widget_settings'); ?> />
            <?php endif; ?>
        ...
        public static function export_widget_settings() {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'export_widget_settings') {
                $backup_url = wp_nonce_url('themes.php?page=automobile_options_page');
               ...
               $automobile_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/widgets-backup/';
               
                $automobile_filename = trailingslashit($automobile_upload_dir) . 'widget_' . (current_time('d-M-Y_H.i.s')) . '.json';

                $automobile_widgets_file = self::parse_export_data($_POST);

                if (!$wp_filesystem->put_contents($automobile_filename, $automobile_widgets_file, FS_CHMOD_FILE)) {
        ...
        public static function automobile_widget_file_delete() {

            global $wp_filesystem,$automobile_var_static_text;
            $strings = new automobile_theme_all_strings;
        $strings->automobile_theme_option_field_strings();
            $automobile_var_file_deleted_successfully = automobile_var_theme_text_srt('automobile_var_file_deleted_successfully');
            ...
            if (is_file($automobile_filename)) {
                ...
                printf($automobile_var_file_deleted_successfully, $file_name);
            } else {
        ...
        public static function ajax_import_widget_data() {
            ...
            if (empty($wp_filesystem)) {
                automobile_include_file(ABSPATH . '/wp-admin/includes/file.php');
                WP_Filesystem();
            }
         ...
         */
        public static function automobile_import_widget_data( $filename = "" ) {
			...
			if ( $filename == "" ) {
				$automobile_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/import-widgets/';

				$file_name = 'import-widgets.json';

				$import_file = trailingslashit($automobile_upload_dir) . $file_name;
			} else {
            ...
            if (is_array($sidebar_data)) {
                ...
                echo '<p><strong>' . automobile_var_theme_text_srt('automobile_var_widget_imported') . '</strong><br />';
            } else {
                echo '<p><strong>' . automobile_var_theme_text_srt('automobile_var_widget_not') . '</strong><br />';
            }
        }
...
$automobile_var_widget_data = new automobile_var_widget_data();
