...
?>
<div class="cs-inventories-main-box" data-ajaxurl="<?php echo admin_url( 'admin-ajax.php' ) ?>" id="primary">
    <!-- Single - Page Slider Start -->
    <div class="cs-banner <?php echo esc_html( $no_image_class ); ?>">
        <?php if ( is_array( $automobile_inv_gallery ) && ! empty( $automobile_inv_gallery ) ) { ?>
            <ul class="cs-banner-slider">
                ...
                foreach ( $automobile_inv_gallery as $automobile_slider_img ) {
                    $automobile_slider_image = automobile_get_image_thumb( $automobile_slider_img, 'automobile_var_media_4' );
                    if ( $automobile_slider_image != '' ) {
                        ?>
                        <li>
                            <div class="cs-media">
                                <figure><img class="lazyload no-src" src="<?php echo esc_url( $automobile_slider_image ); ?>"  alt=""/></figure>
                            </div>
                        </li>
                        <?php
                    }
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
            <div class="cs-button-style">
                <?php if ( $automobile_video_url != '' ) { ?>
                    <a data-toggle="modal" class="btn-video" href="" data-target="#request-video"><i class="icon-play_arrow"></i><?php echo esc_html( automobile_var_plugin_text_srt( 'automobile_var_watch_video' ) ); ?></a>
                <?php } ?>
                <?php
                echo automobile_inventory_compare_det_button( $post->ID );
        ...
        if ( isset( $automobile_video_url ) && $automobile_video_url != '' ) {
            ?>
                                    ...
                                    <div class="cs-button-style">
                                        ...
                                        if ( is_user_logged_in() ) {
                                            ...
                                            if ( isset( $user ) and $user <> '' and is_user_logged_in() ) {
                                                if ( is_array( $finded_result_list ) && ! empty( $finded_result_list ) ) {
                                                    ?>
                                                    <a class="whishlist_icon short-list" href="javascript:void(0)"  data-toggle="tooltip" data-placement="top" title="<?php echo esc_html( automobile_var_plugin_text_srt( 'automobile_var_added_shortlist' ) ); ?>" id="<?php echo 'addjobs_to_wishlist' . intval( $post->ID ); ?>" onclick="automobile_var_removeinventory_to('<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>', '<?php echo absint( $post->ID ); ?>', this)" ><i class="icon-heart"></i>
                                                        <?php echo esc_html( automobile_var_plugin_text_srt( 'automobile_var_shortlisted' ) ); ?>
                                                    </a> 
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a class="whishlist_icon btn-shortlist short-list" href="javascript:void(0)"  data-toggle="tooltip" data-placement="right" title="<?php echo esc_html( automobile_var_plugin_text_srt( 'automobile_var_add_to_shortlist' ) ); ?>" id="<?php echo 'addjobs_to_wishlist' . intval( $post->ID ); ?>" onclick="automobile_var_addinventory_to_wish('<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>', '<?php echo absint( $post->ID ); ?>', this)" ><i class="icon-heart-o"></i> <?php echo esc_html( automobile_var_plugin_text_srt( 'automobile_var_shortlist' ) ); ?></a> 
                                                    <?php
                                                }
                                            } else {
                                                ?>
                                            ...
                                            <form class="row" id="ajaxinfoform" action="#" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-lg-12 col-lg-12 col-sm-12 col-xs-12">
                                                    <div class="cs-modal-field">
                                                        ...
                                                        echo force_balance_tags( $output );
                                                        ?>
                                                        <div id="main-info-loader" class="loader_class"></div>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
