...
$var_arrays = array('automobile_var_fonts_subsets');
$fonts_array_global_vars = AUTOMOBILE_VAR_GLOBALS()->globalizing($var_arrays);
extract($fonts_array_global_vars);
if (!function_exists('automobile_var_get_google_init_arrays')) {

    function automobile_var_get_google_init_arrays() {
        ...
        update_option('automobile_var_font_list', $font_list_init);
        update_option('automobile_var_font_attribute', $font_atts_int);
    }

}
$automobile_var_fonts_subsets = array(
