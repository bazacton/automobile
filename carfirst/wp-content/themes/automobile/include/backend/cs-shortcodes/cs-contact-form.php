...
if (!function_exists('automobile_var_page_builder_contact_form')) {

    function automobile_var_page_builder_contact_form($die = 0) {
        ...
        if (function_exists('automobile_shortcode_names')) {
            ...
            $AUTOMOBILE_PREFIX = 'automobile_contact_form';
            ...
            if (isset($automobile_output['0']['content'])) {
                $contact_us_text = $automobile_output['0']['content'];
            } else {
                $contact_us_text = '';
            }
            ...
            $name = 'automobile_var_page_builder_contact_form';
            ...
            <div id="<?php echo esc_attr($name . $automobile_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?>
                 <?php echo esc_attr($shortcode_view); ?>" item="contact_form" data="<?php echo automobile_element_size_data_array_index($contact_form_element_size) ?>" >
                     <?php automobile_element_setting($name, $automobile_counter, $contact_form_element_size) ?>
                <div class="cs-wrapp-class-<?php echo intval($automobile_counter) ?>
                     <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $automobile_counter) ?>" data-shortcode-template="[automobile_contact_form {{attributes}}]{{content}}[/automobile_contact_form]" style="display: none;">
                    <div class="cs-heading-area" data-counter="<?php echo esc_attr($automobile_counter) ?>">
                        <h5><?php echo automobile_var_theme_text_srt('automobile_var_edit_form'); ?></h5>
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $automobile_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($automobile_var_contact_us_element_title),
                                    'cust_id' => 'automobile_var_contact_us_element_title' . $automobile_counter,
                                    'classes' => '',
                                    'cust_name' => 'automobile_var_contact_us_element_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $automobile_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($automobile_var_contact_us_element_send),
                                    'cust_id' => 'automobile_var_contact_us_element_send' . $automobile_counter,
                                    'classes' => '',
                                    'cust_name' => 'automobile_var_contact_us_element_send[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $automobile_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($automobile_var_contact_us_element_success),
                                    'cust_id' => 'automobile_var_contact_us_element_success' . $automobile_counter,
                                    'classes' => '',
                                    'cust_name' => 'automobile_var_contact_us_element_success[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $automobile_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($automobile_var_contact_us_element_error),
                                    'cust_id' => 'automobile_var_contact_us_element_error' . $automobile_counter,
                                    'classes' => '',
                                    'cust_name' => 'automobile_var_contact_us_element_error[]',
                                    'return' => true,
                                ),
                            );
                        ...
                        <?php } else { ?>
                            ...
                            $automobile_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'cust_id' => 'contact_form_save' . $automobile_counter,
                                    'cust_type' => 'button',
                                    'classes' => '',
 ...
 <script>
    ...
    add_action('wp_ajax_automobile_var_page_builder_contact_form', 'automobile_var_page_builder_contact_form');
}
?>